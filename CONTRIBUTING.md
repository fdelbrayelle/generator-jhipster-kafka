...
If you find a bug in the source code or a mistake in the documentation, you can help us by [submitting a ticket](https://opensource.guide/how-to-contribute/#opening-an-issue) to our [GitHub issues](https://github.com/fdelbrayelle/generator-jhipster-kafka/issues). Even better, you can submit a Pull Request to our [JHipster generator project](https://github.com/fdelbrayelle/generator-jhipster-kafka) or to our [Documentation project](https://github.com/jhipster/jhipster.github.io).
...
You can request a new feature by submitting a ticket to our [GitHub issues](https://github.com/fdelbrayelle/generator-jhipster-kafka/issues). If you
...
Before you submit your issue search the [archive](https://github.com/fdelbrayelle/generator-jhipster-kafka/issues?utf8=%E2%9C%93&q=is%3Aissue), maybe your question was already answered.
...
### Fork the jhipster-kafka project

Go to the [jhipster-kafka project](https://github.com/fdelbrayelle/generator-jhipster-kafka) and click on the "fork" button. You can then clone your own fork of the project, and start working on it.

[Please read the GitHub forking documentation for more information](https://help.github.com/articles/fork-a-repo)

### Set NPM/YARN to use the cloned project

In your cloned `jhipster-kafka` project, type `npm link` or `yarn && yarn link` depending on the package manager you use.

This will do a symbolic link from the global `node_modules` version to point to this folder, so when we run `yo jhipster-kafka`, you will now use the development version of JHipster.
...
To overcome this you need to run `npm link generator-jhipster-kafka` or `yarn link generator-jhipster-kafka` on the generated project folder as well, so that the local version has a symbolic link to the development version of JHipster.

To put it in a nutshell, you need to:

1.  run `npm link` or `yarn link` on the `generator-jhipster-kafka` project
2.  run `npm link generator-jhipster-kafka` or `yarn link generator-jhipster-kafka` on the generated application folder (you need to do this for each application you create)
...
[issue-template]: https://github.com/fdelbrayelle/generator-jhipster-kafka/issues/new?template=BUG_REPORT.md
[feature-template]: https://github.com/fdelbrayelle/generator-jhipster-kafka/issues/new?template=FEATURE_REQUEST.md
